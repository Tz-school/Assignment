...
class _LocationPickerScreenState extends State<LocationPickerScreen> {
  ...
  String _selectedAddress = 'Tap on the map to select an address';

  String _selectedState = '';

  bool _loadingAddress = false;

  // Get address AND state from OpenStreetMap Nominatim
  Future<void> _getAddressFromLocation(LatLng location) async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        // Standardise some Malaysian state names
        state = _standardizeMalaysiaState(state);
  ...
  // Convert Nominatim names into the names used by your app
  String _standardizeMalaysiaState(String state) {
  ...
  void _confirmLocation() {
    ...
    if (_selectedAddress == 'Tap on the map to select an address' ||
        _selectedAddress == 'Finding address...') {
